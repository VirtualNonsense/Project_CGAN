...
class DCGAN(pl.LightningModule):
    ...
    def configure_optimizers(self):
        g_optimizer = torch.optim.Adam(self.generator.parameters(), betas=(0.9, 0.999), lr=0.00065)
        d_optimizer = torch.optim.Adam(self.discriminator.parameters(), betas=(0.9, 0.999), lr=0.00065)
