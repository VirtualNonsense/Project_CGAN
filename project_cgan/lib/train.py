...
from utils import gradient_penalty, save_checkpoint, load_checkpoint, initialize_weights
from generator import CGanGen as Generator
from discriminator import CGanDis as Discriminator
import datamodule
...
if __name__ == '__main__':
    ...
    dataset = datasets.ImageFolder(root=os.environ['CGAN_SORTED'], transform=transforms)
